...
דוח זה סוקר את מצב איכות מי התהום באזור התעשייה חולון על בסיס נתוני ניטור 2010–2026 משולבים עם רקע היסטורי משלוש סדרות סקרים (תה"ל 2007, אקולוג 2009–2017, רשות המים 2021). אזור חולון מאופיין באקוויפר חוף חולי, מפלס מים בעומק ~40 מ', וכיוון זרימה דרום-מערב לכיוון בת ים והים. דוח רשות המים 2021 (טבלה 13, עמ' 30–32) דירג את חולון בין אזורי הסיכון הגבוהים בארץ.

**ממצאים עיקריים:**

1. **TCE — נת חולון 11**: ריכוז שיא של 27,860 µg/L (371,467% מהתקן) נמדד ב-2012; המדידה האחרונה (2024) ב-5,150 µg/L (68,660% מהתקן, אינדקס 8). פלומה מתמשכת ללא דעיכה ברורה.
2. **TCE — נת אלביט חולון 1**: 17,786 µg/L (235,733% מהתקן, אינדקס 8) במדידת 2018, בליווי 1,1-DCE ב-1,939 µg/L. שלוש מדידות בלבד.
3. **TCE — נת חולון 2**: 1,256 µg/L (16,751% מהתקן, אינדקס 8) ב-2022; **ניטור הופסק לאחר מדידה זו**. שני קידוחים סמוכים (נת חולון 2 ו-7) מציגים בו-זמנית מגמות עלייה של PCE, Chloroform ו-trans-1,2-DCE — חתימה של פלומה פעילה ולא יציבה.
4. **TCE — נד סונול המלאכה מ-1**: 18,148 µg/L (36,297% מהתקן, אינדקס 8) במדידת ינואר 2026 — חזרה (rebound) לאחר ניסיונות שיקום באתר תדירגן (2013–2020).
5. **כרום — נת חולון 26**: 4,036 µg/L (8,072% מהתקן, אינדקס 7) ב-2023 — גבוה פי 30 מהקידוח הבא בתור. שלוש מדידות בלבד; דורש אישוש בטרם מעבר להמלצות תפעוליות.
6. **PFAS — פער כיסוי קריטי**: רק 4 מתוך 80 קידוחים פעילים נדגמו, וכולם בריכוז 0; באזור עם 53 קידוחי דלק ומפעלי ציפוי היסטוריים, היעדר נתון אינו אישור היעדר זיהום.
7. **דלק נקודתי**: בנזן עד 8,500 µg/L בנד אגד אזור 1 (2025), MTBE עד 2,415 µg/L בנד אגד אזור 12 (2024) — point-source סביב מגרשי החניה והדלק של אגד; אינו מייצג פיזור אזורי.

מבין 80 הקידוחים הפעילים באזור (27 קידוחי תעשייה + 53 קידוחי דלק), 25 קידוחים עומדים בקריטריון התפעולי לחורגים מובהקים (אינדקס משפחה ≥7 או מגמת עלייה סטטיסטית שחצתה תקן). 12 מגמות Mann-Kendall עלייה מובהקות זוהו (p<0.10), עיקרן במשפחת FUEL וקבוצת CVOC.
...
`bucket(C_last_since_2018 / DWS × 100)`

כאשר `C_last_since_2018` הוא ריכוז המדידה האחרונה (החל מ-2018), `DWS` הוא תקן מי שתייה הישראלי, והפלט נדגם לסקאלת אינדקס 0–8 לפי המיפוי הבא:
...
**חלון זמן**: מ-2018 ואילך. הבחירה נועדה לשקף מצב נוכחי ולא היסטוריה — ריכוזי שיא היסטוריים (לדוגמה TCE 27,860 µg/L בנת חולון 11, 2012) מוזכרים בנפרד כקונטקסט אך לא נכנסים לאינדקס.
