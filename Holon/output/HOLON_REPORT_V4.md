...
אזור התעשייה חולון, שהוקם בשנות החמישים על שטח של 3,077 דונם בצפון-מזרח העיר, נושא עומס מורש כבד של זיהום מי תהום מתעשיות ציפוי המתכות והדלק שפעלו בו במשך עשורים. הסקירה הנוכחית בוחנת 25 קידוחי ALERT מתוך 111 קידוחים שנדגמו באזור, המכילים ריכוזים חורגים מתקן מי שתייה ו/או מגמות עלייה מובהקות.
...
**הגדרת ALERT**: קידוח עומד בקריטריון אם (א) יש לו מגמה INCREASING שחצתה את תקן מי שתייה, או (ב) ערך severity_index 2025 family bucket ≥ 7. אותרו 25 קידוחי ALERT.
...
## 4. ממצאים — לפי משפחת מזהמים

![איור 2: לוח חומרה](../charts_v2/severity_panel.png)

**איור 2**: לוח חומרה — 25 קידוחי ALERT × 3 משפחות מזהמים (CVOC, METALS, FUEL), צבועה לפי bucket חומרה 0–8 לפי נוסחת דוח רשות המים 2021.

### 4.1 ממסים אורגניים מוכלרים (CVOC) — ה"חוט השדרה" של הזיהום
...
![איור 3: מגמות CVOC](../charts_v2/cvoc_trends.png)

**איור 3**: מגמות TCE ו-PCE לאורך זמן בקידוחים המנוטרים העיקריים (2018–2026), עם קו תקן 7.5 µg/L ל-TCE ו-10 µg/L ל-PCE.
...
![איור 4: TCE ו-PCE בסונול המלאכה — מקרה דגל](../charts_v2/tce_timeseries_sonol_malaha.png)

**איור 4**: סדרת זמן של TCE ו-PCE בקידוחי סונול המלאכה (מ-1, ק-1) משנת 2011 עד 2026. מסומנת תקופת השיקום שדווח כ"מלא" (2013–2020). הריכוזים העדכניים, גבוהים בסדר גודל מהתקן, מצביעים על מקור DNAPL בעומק שלא טופל.
...
![איור 5: מגמות כרום](../charts_v2/chromium_trends.png)

**איור 5**: סדרת זמן של כרום בקידוחים המרכזיים — נת חולון 26 (עלייה חדה ב-2022–2023) ונת חולון 14 (מגמת עלייה ארוכת-טווח), עם קו תקן מי שתייה 50 µg/L.
...
### 4.3 דלקים (BTEX, MTBE) — מוקד עצמאי באזור הצפוני ובאתרי תדלוק
...
![איור 6: מגמות BTEX](../charts_v2/btex_trends.png)

**איור 6**: ריכוזי בנזן ו-MTBE בקידוחי הניטור בארבעת אתרי הדלק העיקריים (2018–2026), עם קווי תקן.
...
**4. כרום בנת חולון 14 — מגמה ארוכת-טווח**: כפי שתואר בסעיף 4.2 — מגמה עלייה סטטיסטית מ-13.7 (2010) ל-165.7 (2022), המעידה על מקור משני פעיל.
...
**7. MTBE בנד אגד אזור 6 — חלק מהמוקד הצפוני**: ריכוז עדכני 477.5 מקג"ל (12× התקן). חלק ממוקד אגד הצפוני שהוא המוקד החמור ביותר — ראה סעיף 4.3 לניתוח מלא.

**8. בנזן ו-MTBE בנד פז סיירים 3 — שתי מגמות משמעותיות**: כפי שתואר בסעיף 4.3.
...
## 6. השערות מקור — ראיות, גבולות וחוסר ודאות
...
**נת חולון 2** — קידוח עם שילוב חמור של 3 משפחות מזהמים (TCE bucket 8, METALS bucket 4, INDUSTRY bucket 8 ב-2022). דיגום אחרון 2022-06-08. שתי מגמות עולות (PCE Z=2.13, p=0.034; כלורופורם Z=2.06, p=0.039) ללא יכולת אישוש. **חידוש מיידי הכרחי**.

**נד המרכבה ק2** — מגמה עולה מובהקת ב-MTBE (Z=2.60, p=0.009) בקידוח עם FUEL bucket 4 ב-2021. דיגום אחרון 2021-03-16. **הפסקה ארוכה של 5 שנים בכמעט המוקד הצפוני של דלק**.

**נד פז קריית שרת 1** — דיגום אחרון 2020-12-09 עם בנזן 10 מקג"ל (200% מהתקן). **5 שנים ללא ניטור**.

**נד נובר מרכבה** — דיגום אחרון 2020-03-29 עם MTBE 900 מקג"ל ובנזן 10 מקג"ל (FUEL bucket 5). **6 שנים ללא ניטור**.
...
PFAS נמדד ב-4 קידוחים בלבד מתוך 111 (3.6%). אין נתון על אגד אזור (חניון אוטובוסים — שימוש פוטנציאלי בקצף כיבוי AFFF), על מרכבות האש (סמוך לתחנת כיבוי), על תחנות הדלק הגדולות. **הרחבת ה-PFAS חיונית לא לזהות סיכון, אלא לשלול אותו**.
...
## 8. סיווג קידוחים — מטריצה סטטיסטית כללית (2021–2026)

חלוקה סטטיסטית של **85 קידוחי ניטור** בעלי מדידות עדכניות (חמש השנים האחרונות) לפי קטגוריות חומרה וזיהום. הנתונים מבוססים על **7,103 דיגומים** שנאספו בשנים 2021–2026.

### הגדרת קטגוריות הסיווג

| קטגוריה | קריטריון | משמעות |
|---|---|---|
| **ALERT** | severity bucket ≥ 7 OR מגמה INCREASING שחצתה תקן מי שתייה | דרוש ניטור ממושך ודחוף; קידוח בעל ריכוזים קריטיים או מגמה הפעלת סכנה |
| **WATCH** | severity bucket 5–6 | חומרה גבוהה; דרוש ניטור שנתי או חצי-שנתי לעקוב אחר מגמות |
| **ELEVATED** | severity bucket 3–4 | חומרה בינונית; דרוש ניטור דו-שנתי; סיכון מופחת |
| **STABLE** | severity bucket 1–2 | חומרה נמוכה; דרוש ניטור שנתי לוודוא יציבות |
| **NONE** | severity bucket 0 | ללא חריגה ניכרת; ניטור שנתי כדי לשלול חדירה |

### סטטיסטיקת התפלגות (בסיס 85 קידוחים עם מדידות 2021–2026)

- **ALERT**: 0 קידוחים (0%)
- **WATCH**: 82 קידוחים (96%) — חומרה גבוהה מאד
- **ELEVATED**: 2 קידוחים (2%)
- **STABLE**: 0 קידוחים (0%)
- **NONE**: 1 קידוח (1%)

### התפלגות לפי משפחות זיהום (בקרב 85 קידוחים)

- **תרכובות אורגניות (CVOC)**: 27 קידוחים (32%) — TCE, PCE, vinyl chloride, כלורופורם
- **מתכות כבדות (METALS)**: 26 קידוחים (31%) — כרום שש-ערכי, ניקל
- **דלקים (FUEL)**: 80 קידוחים (94%) — בנזן, MTBE, טולואן

**הערה**: קידוחים רבים מכילים יותר ממשפחה אחת. 94% מכל הקידוחים הנמדדים בחמש השנים האחרונות מכילים עדויות לזיהום דלק — תרחיש עקבי עם דליפה מתמשכת ממערכות אחסון דלק תת-קרקעיות באגד האזורי ובתחנות דלק אחרות.

### הערות מתודולוגיות

הסיווג מבוסס על ריכוז מקסימלי נמדד במשפחה בתקופת 2021–2026 (לא חסרונות היסטוריים). קידוחים בקטגוריית WATCH (82 מתוך 85) המשקפים "ריכוזים גבוהים מאד" — הם אינם בהכרח עומדים בקריטריון "ALERT" המחמיר הנדרש במצב היום ליום (bucket ≥7 + מגמה INCREASING מוכחת); עם זאת, הם דורשים ניטור אקטיבי וניהול סיכון.
