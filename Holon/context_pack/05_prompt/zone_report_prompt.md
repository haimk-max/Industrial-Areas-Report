<!-- RENDERED ARTIFACT — DO NOT EDIT BY HAND.
     Generated by scripts/render_zone_prompt.py --step report at 2026-06-09T09:42:22Z
     template=zone_report_prompt_template_v5.md
     template_sha256_12=acfc52de3562
...
Focus order (from zone_diagnosis.md ## סדר מוקדים): 1. הליבה התעשייתית — נת חולון / אלביט / תדירגן — מוביל: INDUSTRY (CVOC) (max_bucket=8); מיקום: מרכז-מזרח אזה״ת (המלאכה / הנחושת / היוצר)
2. מוקד הדלק המערבי — מחניון אגד — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: מערב אזה״ת (מחניון אגד)
3. מוקד התדלוק הדרומי — פז צבר / פז סיירים / סונול משמר השבעה — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: דרום-מערב אזה״ת
4. מוקד המתכות — כרום נקודתי + גלווני + ארסן + רימטל — מוביל: METALS (max_bucket=7); מיקום: מרכז אזה״ת (תת-אשכול תעשייתי) + המנור 54
5. מוקד דלק "ישן" — מרכבות האש / נובר / סונול המלאכה — מוביל: FUEL (MTBE/TBA) (max_bucket=6); מיקום: מרכז-מערב + מתחם מרכבות האש
6. חזית דיאוקסן דרומית-חקלאית — מוביל: EMERGING (1,4-dioxane) (max_bucket=4); מיקום: שולי דרום-מערב (חווה חקלאית)
7. פערי כיסוי — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: —
...
1. הליבה התעשייתית — נת חולון / אלביט / תדירגן — מוביל: INDUSTRY (CVOC) (max_bucket=8); מיקום: מרכז-מזרח אזה״ת (המלאכה / הנחושת / היוצר)
2. מוקד הדלק המערבי — מחניון אגד — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: מערב אזה״ת (מחניון אגד)
3. מוקד התדלוק הדרומי — פז צבר / פז סיירים / סונול משמר השבעה — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: דרום-מערב אזה״ת
4. מוקד המתכות — כרום נקודתי + גלווני + ארסן + רימטל — מוביל: METALS (max_bucket=7); מיקום: מרכז אזה״ת (תת-אשכול תעשייתי) + המנור 54
5. מוקד דלק "ישן" — מרכבות האש / נובר / סונול המלאכה — מוביל: FUEL (MTBE/TBA) (max_bucket=6); מיקום: מרכז-מערב + מתחם מרכבות האש
...
<document index="5">
<source>Holon/lean_workspace/04_deterministic_anchors/anchors_pilot.yaml (Structured Anchors PILOT)</source>
...
- **Order**: by geographic focus per §IV (1. הליבה התעשייתית — נת חולון / אלביט / תדירגן — מוביל: INDUSTRY (CVOC) (max_bucket=8); מיקום: מרכז-מזרח אזה״ת (המלאכה / הנחושת / היוצר)
2. מוקד הדלק המערבי — מחניון אגד — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: מערב אזה״ת (מחניון אגד)
3. מוקד התדלוק הדרומי — פז צבר / פז סיירים / סונול משמר השבעה — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: דרום-מערב אזה״ת
4. מוקד המתכות — כרום נקודתי + גלווני + ארסן + רימטל — מוביל: METALS (max_bucket=7); מיקום: מרכז אזה״ת (תת-אשכול תעשייתי) + המנור 54
5. מוקד דלק "ישן" — מרכבות האש / נובר / סונול המלאכה — מוביל: FUEL (MTBE/TBA) (max_bucket=6); מיקום: מרכז-מערב + מתחם מרכבות האש
6. חזית דיאוקסן דרומית-חקלאית — מוביל: EMERGING (1,4-dioxane) (max_bucket=4); מיקום: שולי דרום-מערב (חווה חקלאית)
7. פערי כיסוי — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: —); families secondary within each focus; "פערי כיסוי" last
...
- [ ] Focus order correct: §3 = geographic foci (חומרה יורדת); families secondary within focus; "פערי כיסוי" last (ראה §IV; order per 1. הליבה התעשייתית — נת חולון / אלביט / תדירגן — מוביל: INDUSTRY (CVOC) (max_bucket=8); מיקום: מרכז-מזרח אזה״ת (המלאכה / הנחושת / היוצר)
2. מוקד הדלק המערבי — מחניון אגד — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: מערב אזה״ת (מחניון אגד)
3. מוקד התדלוק הדרומי — פז צבר / פז סיירים / סונול משמר השבעה — מוביל: FUEL (BTEX/MTBE) (max_bucket=8); מיקום: דרום-מערב אזה״ת
4. מוקד המתכות — כרום נקודתי + גלווני + ארסן + רימטל — מוביל: METALS (max_bucket=7); מיקום: מרכז אזה״ת (תת-אשכול תעשייתי) + המנור 54
5. מוקד דלק "ישן" — מרכבות האש / נובר / סונול המלאכה — מוביל: FUEL (MTBE/TBA) (max_bucket=6); מיקום: מרכז-מערב + מתחם מרכבות האש
