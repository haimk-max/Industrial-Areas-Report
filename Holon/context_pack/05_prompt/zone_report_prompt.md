<!-- RENDERED ARTIFACT — DO NOT EDIT BY HAND.
     Generated by scripts/render_zone_prompt.py --step report at 2026-06-08T11:50:34Z
     template=zone_report_prompt_template_v5.md
     template_sha256_12=f8b140a47d6e
...
Focus order (from zone_diagnosis.md ## סדר מוקדים): 1. מוקד CVOC תעשייתי מרכזי (כולל חזית 1,4-dioxane חקלאית מורד-הזרימה כתת-מוקד) — מוביל: CVOC (max_bucket=8); מיקום: מרכז-מערב — המלאכה, השופטים, הסולל, היוצר, הנגר; חזית מורד-זרימה דרום-מזרח — נת חווה חקלאית א/ב
2. מוקד דלקים — חניוני אגד וצי המרכבות — מוביל: FUEL (max_bucket=8); מיקום: מערב/צפון-מערב — חניון אגד, צי מרכבות-האש, פז-סיירים
3. מוקד Cr נקודתי + אשכול Cr+Ni — מוביל: METALS (max_bucket=8); מיקום: דרום-מרכז — נת חולון 14, 22, 23, 24, 25, 26
4. פערי כיסוי (PFAS + ניטור-הפסק) — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: כל-האזור
...
1. מוקד CVOC תעשייתי מרכזי (כולל חזית 1,4-dioxane חקלאית מורד-הזרימה כתת-מוקד) — מוביל: CVOC (max_bucket=8); מיקום: מרכז-מערב — המלאכה, השופטים, הסולל, היוצר, הנגר; חזית מורד-זרימה דרום-מזרח — נת חווה חקלאית א/ב
2. מוקד דלקים — חניוני אגד וצי המרכבות — מוביל: FUEL (max_bucket=8); מיקום: מערב/צפון-מערב — חניון אגד, צי מרכבות-האש, פז-סיירים
3. מוקד Cr נקודתי + אשכול Cr+Ni — מוביל: METALS (max_bucket=8); מיקום: דרום-מרכז — נת חולון 14, 22, 23, 24, 25, 26
4. פערי כיסוי (PFAS + ניטור-הפסק) — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: כל-האזור
...
- **Order**: by geographic focus per §IV (1. מוקד CVOC תעשייתי מרכזי (כולל חזית 1,4-dioxane חקלאית מורד-הזרימה כתת-מוקד) — מוביל: CVOC (max_bucket=8); מיקום: מרכז-מערב — המלאכה, השופטים, הסולל, היוצר, הנגר; חזית מורד-זרימה דרום-מזרח — נת חווה חקלאית א/ב
2. מוקד דלקים — חניוני אגד וצי המרכבות — מוביל: FUEL (max_bucket=8); מיקום: מערב/צפון-מערב — חניון אגד, צי מרכבות-האש, פז-סיירים
3. מוקד Cr נקודתי + אשכול Cr+Ni — מוביל: METALS (max_bucket=8); מיקום: דרום-מרכז — נת חולון 14, 22, 23, 24, 25, 26
4. פערי כיסוי (PFAS + ניטור-הפסק) — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: כל-האזור); families secondary within each focus; "פערי כיסוי" last
...
- Borehole count: 46 general + 63 fuel = 111
...
- **Consistency**: Borehole count must match 111 everywhere
...
- [ ] Focus order correct: §3 = geographic foci (חומרה יורדת); families secondary within focus; "פערי כיסוי" last (ראה §IV; order per 1. מוקד CVOC תעשייתי מרכזי (כולל חזית 1,4-dioxane חקלאית מורד-הזרימה כתת-מוקד) — מוביל: CVOC (max_bucket=8); מיקום: מרכז-מערב — המלאכה, השופטים, הסולל, היוצר, הנגר; חזית מורד-זרימה דרום-מזרח — נת חווה חקלאית א/ב
2. מוקד דלקים — חניוני אגד וצי המרכבות — מוביל: FUEL (max_bucket=8); מיקום: מערב/צפון-מערב — חניון אגד, צי מרכבות-האש, פז-סיירים
3. מוקד Cr נקודתי + אשכול Cr+Ni — מוביל: METALS (max_bucket=8); מיקום: דרום-מרכז — נת חולון 14, 22, 23, 24, 25, 26
4. פערי כיסוי (PFAS + ניטור-הפסק) — מוביל: PFAS (ואחרים) (max_bucket=—); מיקום: כל-האזור)
