...
|---|------|--------|--------|----------------|--------|
| 21 | Verification Rerun — Full V5 pipeline regeneration (strict SSOT) | משתמש דורש הרצה מלאה צמודה ב-100% למסמכי הניהול. ניסיון ראשון (סוכני 3a/3b בפרומפט מקורי) נעצר ע"י המשתמש לאחר זיהוי שהפרומפטים נוסחו מזיכרון ולא מהתבניות הרשמיות. החל מ-commit 6e87a87, מתבצעת **הרצה חדשה צמודה ל-SSOTs**: (1) Steps 1-3 דטרמיניסטיים — hash IDENTICAL ל-backup (1559137). (2) Step 3 contextual — פרומפטים מייבאים PROCESS_GUIDE §I + Evidence Classification A-E. (3) Step 4 — `scripts/templates/zone_diagnosis_prompt_template.md` instantiated. (4) Step 5 — `scripts/templates/zone_report_prompt_template_v5.md` + REPORT_V5_SCHEMA מצורף. (5) Step 6+7 — סקריפטים דטרמיניסטיים. גיבוי: `Holon/_backup_2026-05-28/` (80MB, hash-verified). יציאה ב-`Holon/rerun_2026-05-28/` — לא דורס. | 🔄 In Progress (Strict SSOT) | 2026-05-28 | Holon/rerun_2026-05-28/, branch: rerun-verification-2026-05-28 |
