...
**עודכן אחרון**: 2026-06-16 (REQ #32 closed — figure-caption alignment 5-fig + RTL fix scoped to report deliverables; REQ #33 closed — Raanana V5 pipeline merge + branch consolidation + toolkit move + qa Gate 6 zone-relative)
